...
assert.match(app, /listeningText/);
assert.match(html, /class="choice-text"/);
assert.match(read("styles.css"), /grid-template-columns: 1fr; gap: 11px/);
assert.match(serviceWorker, /toeic-part2-beat-v1\.1\.0/);
